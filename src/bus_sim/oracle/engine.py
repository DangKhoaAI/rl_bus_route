...
from bus_sim.oracle.costs import add_costs, integrate_tick_costs
...
from bus_sim.oracle.passengers import abandon_expired, board_visit
...
def advance_tick(state: WorldState, scenario: Scenario) -> StepCosts:
    ...
    from bus_sim.oracle.dispatcher import dispatch_ready
