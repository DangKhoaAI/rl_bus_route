...
from bus_rl.control.actions import ACTION_TABLE, HEADWAYS
from bus_rl.data.scenario import DEFAULT_COUNTS, SPLIT_SEEDS, generate_manifest
...
def _load_reference(root: Path) -> dict | None:
    path = Path(root) / "tests" / "backend_parity" / "reference" / "reference.json"
...
def build_manifest(root: Path) -> dict:
    ...
    payload = {
        ...
        "scenario_order": {
            ...
            "generator": "bus_rl.data.scenario.generate_manifest (SeedSequence.spawn)",
