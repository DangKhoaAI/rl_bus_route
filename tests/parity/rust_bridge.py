"""Python adapter that drives the native `bus_sim_native` kernel and shapes its output
...
from bus_rl.execution.environments.rust.bridge import build_kernel as _build_kernel
from bus_rl.execution.environments.rust.bridge import scenario_payload
from bus_sim.parity.fixtures import flatten
from bus_sim.parity.scenarios import CONTROL_FLAGS, build_scenario
